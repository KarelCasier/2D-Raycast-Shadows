...
void DrawDebugLine(const sf::Vector2f& A, const sf::Vector2f& B, sf::RenderTarget& target, const sf::Color& colour = sf::Color::Yellow);

/// Utility to draw a line takes four floats(x1,y1,x2,y2), sf::RenderWindow, and a colour (optional)
void DrawDebugLine(const float& ax, const float& ay, const float& bx, const float& by, sf::RenderTarget& target, const sf::Color& colour = sf::Color::Yellow);

/// Utility to draw a line takes two sf::Vector2f (start position, direction), float norm, sf::RenderWindow, and a colour (optional)
void DrawDebugLine(sf::Vector2f pos, sf::Vector2f& dir, float& norm, sf::RenderTarget& target, const sf::Color& colour = sf::Color::Yellow);

///Draw debug circle
void DrawDebugCircle(const sf::Vector2f& pos, const float& radius, sf::RenderTarget& target, const sf::Color& colour = sf::Color::Yellow);
...
/// Centers the given sf::Shape at the orgin
